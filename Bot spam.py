...
BOT_TOKEN = "MTQ1MDEwMzkzNzIzNDM3NDY4Ng.GLWSSa.WYcruvsZYiNc4yLH_PaS_iyF4zkrxWgLtueov0"

FUNK_TEXT = """ # พ่อมึงตายสัสจังไรดูดม้าลูกทรพีหีแม่มึงเล็กหำพ่อมึงเล็กเกิดมาได้ไงวะก็ละงงทำตัวไม่มีประโยชชาติหมาชิบหาบไอชิบหายดิสก็กระจอกหัวดิสไม่ทำไรเลยโดนยิงนี้โง่จัดควายก็ควายสมองหมาชิบหายน่าขำวะสภาพดิสกระจอกดิสโง่ๆควายไก่วะคนเขมรรึไงวะไปเป็นเขมรเถอะสัสอีคางคกอิหมอยชนดกพ่อกับแมมีงน่าจะเย็ดกันถึงมีงมาได้แค่เย็ดแบบยัดหม่เข้าเพราะหีแม่มึงเท่ารูเข็มหำพ่อมึงสั้นควายๆโง่สมองหมาปัญญาควาย
"""
